...
//  Level.h
//
//  Representation of a level for the CS 115 roguelike game.
//
//  By Howard Hamilton
...
void findMonsterStart (const Level level,
                       int& row, int& column);

void findPlayerStart (const Level level,
                      int& row, int& column);

unsigned int getCost (const Level level,
                      int row, int column);
