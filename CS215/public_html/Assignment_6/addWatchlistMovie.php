<?php
    ...
    if(! empty($_POST)){
        ...
        $query = "SELECT * FROM Movie_Table WHERE Movie_Name = '$MName'";
        ...
        if($result->num_rows > 0){
            ...
            $query = "INSERT INTO Bridge (Movie_ID, Watchlist_ID, Add_Time) 
            VALUES ('$MID', '$watchlistID', '$currentDate')";
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <!------------------------------------------------------------------------------------------------------------>
            <div class="container">
                <form id = "playlistForm" method="post" action="addWatchlistMovie.php?watchlistID=<?=$watchlistID?>">
