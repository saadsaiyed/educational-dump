<?php
    ...
    if(! empty($_POST)){
        ...
        $select = "SELECT * FROM Watchlist_Table WHERE User_ID = '$UID' AND Watchlist_Name = '$PName' AND Create_Time = '$currentDate'";
        $result = runQuery($select);
        $row = mysqli_fetch_array($result);
        $WID = $row['Watchlist_ID'];
        header("Location: watchlistLayout.php?watchlistID=$w");
    }
?>
<!DOCTYPE html>
<html>
